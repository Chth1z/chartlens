...
class DocumentFragmentRecord(Base):
    ...
    layout_region_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    parser_version: Mapped[str] = mapped_column(String(128), default="")
...
class ProcessingRunRecord(Base):
    ...
    system_config_version: Mapped[str] = mapped_column(String(64), default="")
    field_dictionary_version: Mapped[str] = mapped_column(String(64), default="")
