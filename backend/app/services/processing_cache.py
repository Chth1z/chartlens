...
from app.schemas.pipeline import DocumentFragment, OcrBlock
from app.services.system_config import OcrProfileConfig

CACHE_VERSION = "v2"


def cache_key(*, file_hash: str, ocr_profile_name: str, layout_profile_name: str, ocr_profile: OcrProfileConfig) -> str:
    payload = {
